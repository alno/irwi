...
* <tt>formatter</tt> - Formatter instance, which process wiki content before output. It should have method <tt>format</tt>, which gets a string and returns it formatted. By default instance of <tt>Riwiki::Formatters::RedCloth</tt> is used (requires RedCloth gem). Other built-in formatter is <tt>Riwiki::Formatters::BlueCloth</tt> (requires BlueCloth gem). 
